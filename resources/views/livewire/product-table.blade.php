                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50  px-5">
                                <tr>
                                    ...
                                    @include('livewire.theaders.th', [
                                        'name' => 'stock', //column name from db
                                        'columnName' => 'Stock', //display name
                                    ])
                                    ...
                                    @foreach ($products as $product)
                                        <tr wire:key="{{ $product->id }}">
                                            ...
                                            <td>
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="block text-sm  text-gray-800">{{ str($product->description)->words(8) }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium">
                                                        Rp {{ $product->price }}
                                                    </span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="text-sm text-gray-500">{{ date('D M Y, H:i', strtotime($product->created_at)) }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
