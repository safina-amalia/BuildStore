                                        ...
                                        <tr wire:key="{{ $category->id }}">
                                            <td class="size-px  px-5">
                                                <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800">{{ str($category->name)->words(3) }}</span>
                                                    </div>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5">
                                                    {{-- <a class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                                        href="#">
                                                        Delete
                                                    </a> --}}
