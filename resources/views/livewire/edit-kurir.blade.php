<div>
    ...
    <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="bg-slate-100 rounded-xl shadow p-4 sm:p-7">
            <form wire:submit.prevent="updateKurir">
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 border-t border-gray-200">
                    ...
                    @foreach ([['label' => 'Nama Kurir', 'model' => 'nama', 'type' => 'text'], ['label' => 'Email', 'model' => 'email', 'type' => 'email'], ['label' => 'No Telepon', 'model' => 'no_tlp', 'type' => 'text'], ['label' => 'Password (Kosongkan jika tidak ingin mengubah)', 'model' => 'password', 'type' => 'password']] as $field)
