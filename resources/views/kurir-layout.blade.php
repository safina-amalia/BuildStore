...
<body>
    ...
    <div class="flex justify-between items-center p-4 bg-white border-b">
        <div class="flex items-center">
            <a class="text-xl font-semibold" href="{{ route('kurir.dashboard') }}">Kurir Dashboard</a>
        </div>
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.away="open = false"
                ...
                <div class="py-1">
                    <a href="{{ route('kurir.edit-profile') }}"
            ...
            <div
                ...
                <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                    <ul class="flex flex-col space-y-1">
                        <li>
                            <a wire:navigate
                                class="flex items-center gap-x-3.5 py-2 px-2.5 {{ Request::is('kurir/dashboard') ? 'bg-gray-100' : '' }} text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                        ...
                        <li>
                            <a wire:navigate
                                class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ Request::is('kurir/orders') ? 'bg-gray-100' : '' }} text-gray-800 rounded-lg hover:bg-gray-100"
                                href="/kurir/orders">
                                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M3 3h13v13H3z" />
                                    <path d="M16 8h4l1 2v6h-5z" />
